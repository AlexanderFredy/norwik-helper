...
1.5 раза выносится наверх предупреждений; если отношение совпало с коэффициентом упаковки
из `alt_units`, причина называется прямо («цена за упаковку, а не за м²»). Не блокирует.
