...
заведены, как они названы, какие цены стоят и чего не хватает. Поэтому:
...
— «нормализация наименований» — ОДНА НА МАРКУ, без коллекции. **Не разбирай, что именно
  ...
  сравнивает их с текущими и сам доложит расхождения. Выгрузки номенклатуры 1С у тебя
  сейчас нет — судить о том, соответствуют ли имена шаблону, тебе попросту не по чему.
