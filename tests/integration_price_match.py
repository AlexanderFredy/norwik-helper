...
- **Таблица расхождений коэффициентов ЕИ** (ОБЯЗАТЕЛЬНО, для сопоставленных позиций, где
  есть фасовка в прайсе): наименование, ref, ЕИ, коэффициент прайса → 1С (`alt_units`),
  совпадает/расходится. Если расхождений нет — так и напиши «расхождений коэффициентов нет».
